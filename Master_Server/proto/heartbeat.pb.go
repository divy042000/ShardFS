...
type HeartbeatRequest struct {
	...
	StoragePath   string                 `protobuf:"bytes,2,opt,name=storage_path,json=storagePath,proto3" json:"storage_path,omitempty"`      // Added to match chunk server
	FreeSpace     int64                  `protobuf:"varint,3,opt,name=free_space,json=freeSpace,proto3" json:"free_space,omitempty"`           // Shifted to align field numbers
	CpuUsage      float32                `protobuf:"fixed32,4,opt,name=cpu_usage,json=cpuUsage,proto3" json:"cpu_usage,omitempty"`             // Added
	MemoryUsage   float32                `protobuf:"fixed32,5,opt,name=memory_usage,json=memoryUsage,proto3" json:"memory_usage,omitempty"`    // Added
	NetworkUsage  float32                `protobuf:"fixed32,6,opt,name=network_usage,json=networkUsage,proto3" json:"network_usage,omitempty"` // Added
	Load          float32                `protobuf:"fixed32,7,opt,name=load,proto3" json:"load,omitempty"`                                     // Added
	ChunkIds      []string               `protobuf:"bytes,8,rep,name=chunk_ids,json=chunkIds,proto3" json:"chunk_ids,omitempty"`               // Renamed from stored_chunks for consistency
